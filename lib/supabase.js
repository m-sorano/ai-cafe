...
// Supabaseクライアントの初期化
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://vfyqhpgrsfupsahmyzuf.supabase.co';
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZmeXFocGdyc2Z1cHNhaG15enVmIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTk5NTIxMzksImV4cCI6MjAxNTUyODEzOX0.qEIwlZCKJMzQVZzP5uQQzJQJlGSNDjANV5E_q1lqQXY';

// 環境変数が設定されていない場合の警告
if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
  console.warn('⚠️ Supabase URLまたは匿名キーが設定されていません。.env.localファイルを作成し、NEXT_PUBLIC_SUPABASE_URLとNEXT_PUBLIC_SUPABASE_ANON_KEYを設定してください。');
}
...
// サービスロールキーがある場合は、管理者クライアントも作成
const serviceRoleKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZmeXFocGdyc2Z1cHNhaG15enVmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY5OTk1MjEzOSwiZXhwIjoyMDE1NTI4MTM5fQ.Yx9PqLEYFbJKTLgOAqROfbkmIQPcIaLOo9MKWUNp9XM';
